...
const pageClass = "mx-auto w-full max-w-[1480px] text-[#1f1b17]";
const cardClass =
...
export const AdminPanelSkeleton = () => (
  <section
    className="w-full max-w-md rounded-md border border-[#eadfd2] bg-[#fffaf4] p-5 shadow-[0_14px_34px_rgba(62,45,28,0.06)]"
    aria-label="Loading"
  >
  ...
  <main className={pageClass} aria-label="Loading dashboard">
    ...
    <section className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1fr)_360px]">
      <div className="rounded-md border border-[#eadfd2] bg-[#fffaf4] p-5 shadow-[0_18px_45px_rgba(62,45,28,0.08)]">
        ...
        <div className="mt-4 h-[260px] rounded-md border border-[#eadfd2] bg-[#fffdf9] p-4">
      ...
      <aside className="rounded-md border border-[#eadfd2] bg-[#fffaf4] p-5 shadow-[0_18px_45px_rgba(62,45,28,0.08)]">
        ...
        <div className="mt-4 space-y-3">
          {Array.from({ length: 5 }).map((_, index) => (
            <div key={index} className="rounded-md border border-[#eadfd2] bg-[#fffdf9] p-3">
    ...
    <section className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
      <div className="space-y-4">
        {Array.from({ length: 4 }).map((_, index) => (
          <article
            key={index}
            className="rounded-md border border-[#eadfd2] bg-[#fffaf4] p-4 shadow-[0_18px_45px_rgba(62,45,28,0.08)]"
          >
      ...
      <aside className="xl:sticky xl:top-6 xl:self-start">
        <section className="rounded-md border border-[#eadfd2] bg-[#fffaf4] p-4 shadow-[0_18px_45px_rgba(62,45,28,0.08)]">
          ...
          {Array.from({ length: 4 }).map((_, index) => (
            <div
              key={index}
              className="mt-4 rounded-md border border-[#eadfd2] bg-[#fffdf9] p-4"
            >
              <SkeletonBlock className="h-3 w-28 rounded-full" />
