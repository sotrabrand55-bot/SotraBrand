...
export const sotraVideoGallery = [
  {
    ...
    type: "video",
    src: sotraVideo,
    label: "SotraBrand modest fashion video",
  },
  {
    id: "sotra-gallery-header-1",
    type: "image",
    src: header1,
    alt: "SotraBrand abaya styling",
  },
  {
    id: "sotra-gallery-header-2",
    type: "image",
    src: header2,
    alt: "SotraBrand modest wardrobe styling",
  },
  {
    id: "sotra-gallery-hijabs",
    type: "image",
    src: hijabProducts,
    alt: "SotraBrand hijab essentials",
  },
  {
    id: "sotra-gallery-blouse",
    type: "image",
    src: blouse1,
